...
exports.needsPermission = function (perm) {
    return exports.async(async function (req, res, next) {
        if (!provePermission(req.user.permissions, perm))
...
exports.catchFiles = function () {
    return [connect_busboy({}), async function (req, res, next) {
