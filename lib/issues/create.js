...
var { catchFiles, requiresLogin, insertActivity, async } = require("../common");
var debug = require("../debug");

router.get(vroot + "issues/create", requiresLogin, async(async function (req, res, next) {
...
router.post(vroot + "issues/create", catchFiles(), async(async function (req, res, next) {
