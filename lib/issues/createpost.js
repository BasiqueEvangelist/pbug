...
var { insertActivity, async, needsPermission } = require("../common.js");

router.post(vroot + "issues/:issue", needsPermission("issues.post"), async(async function (req, res, next) {
