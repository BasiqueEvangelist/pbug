...
var { requiresLogin, insertActivity, catchFiles, async } = require("../common.js");

router.get(vroot + "issues/post/:post/edit", requiresLogin, async(async function (req, res, next) {
