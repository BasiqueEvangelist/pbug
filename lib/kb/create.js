...
var { needsPermission, async } = require("../common.js");

router.get(vroot + "kb/create", needsPermission("kb.create"), function (req, res, next) {
    res.render("kb/create");
});

router.post(vroot + "kb/create", needsPermission("kb.create"), async(async function (req, res, next) {
