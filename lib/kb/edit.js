...
router.get(vroot + "kb/:infopage/edit", requiresLogin, async function (req, res, next) {
...
router.post(vroot + "kb/:infopage/edit", requiresLogin, async function (req, res, next) {
